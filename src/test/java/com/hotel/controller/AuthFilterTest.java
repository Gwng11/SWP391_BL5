...
class AuthFilterTest {
    ...
    @Test void anonymousUserIsRedirected()throws Exception{when(req.getRequestURI()).thenReturn("/manager/dashboard");when(session.getAttribute(Constants.SESSION_USER)).thenReturn(null);filter.doFilter(req,resp,chain);verify(resp).sendRedirect("/login");}
