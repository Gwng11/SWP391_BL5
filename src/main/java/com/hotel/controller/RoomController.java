...
public class RoomController extends BaseController {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // F02: form tìm kiếm + kết quả; parse dữ liệu trong try để lỗi nhập liệu không
        // thành HTTP 500.
        ...
        try {
            ...
            req.setAttribute("results", page.items());
            req.setAttribute("currentPage", page.currentPage());
            req.setAttribute("totalPages", page.totalPages());
            req.setAttribute("totalResults", page.totalItems());
            req.setAttribute("nights", ChronoUnit.DAYS.between(checkIn, checkOut));
        } catch (IllegalArgumentException e) {
            req.setAttribute("err", e.getMessage());
            req.setAttribute("results", List.of());
