            ...
            <c:forEach var="r" items="${reservations}">
              <tr>
                ...
                <td style="text-align: right;">
                  ...
                  <c:if test="${r.serviceRequestEligible}">
                    <a class="btn btn-success btn-small" href="${pageContext.request.contextPath}/services?reservationId=${r.reservationId}">🛠️ Đặt dịch vụ</a>
                  </c:if>
