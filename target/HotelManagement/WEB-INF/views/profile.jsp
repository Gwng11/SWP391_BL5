...
<div class="card">
  ...
  <form method="post" action="${pageContext.request.contextPath}/profile" style="max-width:520px">
    ...
    <label>Địa chỉ</label><input name="address" value="${user.address}" style="width:100%" maxlength="250">
    <label>Thông tin định danh</label><input name="identificationNumber" value="${user.identificationNumber}" style="width:100%" maxlength="100">
